...
cfg.output_dir = 'Y:/user/yrso/result/StyleGAN_celebAhq/try1/'
cfg.device = 'cuda'
cfg.device_id = '0'
...
cfg.sched.epochs = [4, 4, 4, 4, 8, 16, 32, 64]
# batches for oen 1080Ti with 11G memory
cfg.sched.batch_sizes = [16, 16, 16, 8, 4, 4, 2, 1, 1]
...
# ---------------------------------------------------------------------------- #
cfg.dataset = CN()
cfg.dataset.img_dir = "Y:/user/yrso/data/celebA_hq/train"
